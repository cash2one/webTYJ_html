...
define(function (require) {
    ...
    app.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            //企业客户管理查询end
            //物业模块选择start
            .state('index.baseManagement.project.professionalLineManagement', {
                url: '/professionalLineManagement',
                templateUrl: 'main/baseManagement/project/professionalLineManagement/professionalLineManagement.html',
                controllerUrl: 'main/baseManagement/project/professionalLineManagement/professionalLineManagement',
