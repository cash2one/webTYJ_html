...
define(function (require) {
    ...
    app.controller('staffsuperviseITCheckCtrl', ['$scope', '$http','$rootScope', '$location','$filter',function ($scope,$http,$rootScope,$location,$filter){
        ...
        $scope.toUpdate = function () {
            ...
            if($scope.showStatus==0){
                ...
                if ($scope.chooseData.datas.length > 1) {
                    ...
                    $scope.staff1.birthday = new Date($scope.staff1.birthday);
                    $("#birthdayEdit").val($scope.staff1.birthday);
            ...
            $(function(){
                ...
                $("#excelupload").zyUpload({
                    ...
                    onSuccess: function(file, response){          // 文件上传成功的回调方法
                        ...
                        $http.post(url + "/staff/importDataFromExcelFile",{Annex:$scope.annexExcel}).success(function(data){
