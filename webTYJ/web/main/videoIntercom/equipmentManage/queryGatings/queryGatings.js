...
/*
        ...
        $scope.addGating = function(){
            var info = {equipmentSn : '', qualityTimeStart :'', equipmentName : '', qualityTerm :'', equipmentModel : '', companyId : companyId};
        ...
        $scope.eqListSave = function(){
            ...
            for(var i = 0; i < $scope.gatingNewList.length; i++){
                var b = {eqName : $scope.gatingNewList[i].equipmentName, eqModel : $scope.gatingNewList[i].equipmentModel, eqSn : $scope.gatingNewList[i].equipmentSn}
                a.push(b);
            }
            ...
            $http.post($rootScope.saasUrl+'/eqInvoiceLog/checkEq', fd, {
                ...
                if(data.state == 'error'){
                    ...
                    $http.post(url + "/Gating/addNewGating/", {Gating:$scope.gatingNewList}).success(function(data){
                        if(data.state == 'success'){
        ...
        $scope.repairUpload = function () {
            ...
            for (var i = 0; i<$scope.chooseData.datas.length; i++){
                ...
                a.snCode = $scope.chooseData.datas[i].equipmentSn;
