...
define(function (require) {
    ...
    app.controller('queryCustomersCheckCtrl', ['$scope', '$http','$rootScope','$location', function ($scope,$http,$rootScope,$location) {

        $scope.doClick(4);//增加tab高亮显示  王洲  2016.2.2
        ...
        $scope.getdata=function(items){
            ...
            for(var i=0;i<chk.length;i++){
                if( chk[i].checked==true){
                    ...
                    //判断婚姻状况
                    if($scope.person.marrieState == 0){
                        $scope.person.marrieState = '0';
                    }
                    if($scope.person.marrieState == 1){
                        $scope.person.marrieState = '1';
                    }
                    //判断证件类型
                    if($scope.person.cardType == 0){
                        $scope.person.cardType = '0';
                    }
                    if($scope.person.cardType == 1){
        ...
        $scope.updatePerson=function(){
            ...
            if($scope.checkUpdate){
                $http.put(url+'/PersonCustNew/updatePersonCustNewRestful',{PersonCustNew:$scope.person}).success(function(){
                ...
                layer.msg("您填写的数据已存在",{icon : 3,time : 2000});
            }
