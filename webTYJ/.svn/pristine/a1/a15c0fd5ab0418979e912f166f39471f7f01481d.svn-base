define(function (require) {
    ...
    app.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('index.workBench.majorEvent.eventTasks', {
                url: '/eventTasks',
                views: {
                    'main@index': {
                        templateUrl: 'main/workBench/majorEvent/eventTasks/eventTasks.html',
                        controllerUrl: 'main/workBench/majorEvent/eventTasks/eventTasks',
                        controller: 'eventTasksCtrl',
                        dependencies: ['services/PageServices','services/valueCheck']
                    }
                }
            })
